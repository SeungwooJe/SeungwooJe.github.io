...
if(/\/seungwoo\.html$/i.test(location.pathname)){document.querySelectorAll('.profile-copy p').forEach(p=>{p.textContent=p.textContent.replace('ACM CHI, UIST, DIS, IEEE ISMAR, TEI, IEEE ToH, TVCG, IJHCS, and IJHCI','ACM CHI, UIST, DIS, TEI, IEEE ISMAR, ToH, TVCG, IJHCS, and IJHCI')})}
